...
static const Rule rules[] = {
        ...
        {  NULL,                  NULL,     "tmux",                1 << 0,    False,      True,       -1 },
        { "Firefox",              NULL,      NULL,                 1 << 1,    False,      True,       -1 },
        { "OperaNext",            NULL,      NULL,                 1 << 1,    False,      True,       -1 },
        ...
        { "Qalculate-gtk",        NULL,      NULL,                 0,         True,       True,       -1 },
        ...
        { "Zenity",               NULL,      NULL,                 0,         True,       True,       -1 },
        {  NULL,                  NULL,     "pygtk-shutdown",      0,         True,       True,       -1 },
};
